...
export default class Faq extends React.Component {
  ...
  render() {
    ...
    const tabs_content = {
      peluqueria: <div className="util-info">
        <p>Linares cuenta con numerosas peluquerías en las que poder ponerte guap@ para la boda. Nosotros, personalmente, conocemos las siguientes:</p>
          ...
          <List.Item>
            ...
            <List.Content>
              ...
              <List.Description>Corredera de San Marcos, 46.<br/>
                <a href="tel:953 60 06 69"><Icon name='phone'/>953 60 06 69</a>
              </List.Description>
            </List.Content>
          </List.Item>
          <List.Item>
            ...
            <List.Content>
              ...
              <List.Description>Calle Cervantes, 10.<br/>
                <a href="tel:953 65 22 21"><Icon name='phone'/>953 65 22 21</a>
              </List.Description>
            </List.Content>
          </List.Item>
          <List.Item>
            ...
            <List.Content>
              ...
              <List.Description>Calle Julio Burell, 30.<br/>
                <a href="tel:606 10 53 79"><Icon name='phone'/>606 10 53 79</a>
              </List.Description>
            </List.Content>
          </List.Item>
        </List>
          ...
          <List.Item>
            ...
            <List.Content>
              ...
              <List.Description>Calle Santiago, 3.<br/>
                <a href="tel:953 69 30 40"><Icon name='phone'/>953 69 30 40</a>
              </List.Description>
            </List.Content>
          </List.Item>
          <List.Item>
            ...
            <List.Content>
              ...
              <List.Description>Calle Cid Campeador, 11.<br/>
                <a href="tel:953 65 04 00"><Icon name='phone'/>953 65 04 00</a>
              </List.Description>
            </List.Content>
          </List.Item>
          <List.Item>
            ...
            <List.Content>
              ...
              <List.Description>Calle Cervantes, 23.<br/>
                <a href="tel:953 69 05 00"><Icon name='phone'/>953 69 05 00</a>
              </List.Description>
            </List.Content>
          </List.Item>
        </List>
            ...
            <List.Item>
              ...
              <List.Content>
                ...
                <List.Description>Taberna: Calle Espronceda, 22<br/>
                  ...
                  <a href="tel:953 60 25 32"><Icon name='phone'/>953 60 25 32</a>
                </List.Description>
              </List.Content>
            </List.Item>
            <List.Item>
              ...
              <List.Content>
                ...
                <List.Description>Calle Doctor, 13.<br/>
                  <a href="tel:953 65 10 72"><Icon name='phone'/>953 65 10 72</a>
                </List.Description>
              </List.Content>
            </List.Item>
            <List.Item>
              ...
              <List.Content>
                ...
                <List.Description>Avenida de España, 83.<br/>
                  <a href="tel:953 69 40 09"><Icon name='phone'/>953 69 40 09</a>
                </List.Description>
              </List.Content>
            </List.Item>
            <List.Item>
              ...
              <List.Content>
                ...
                <List.Description>Calle Pérez Galdós (Ventanas), 27.<br/>
                  <a href="tel:697 92 49 93"><Icon name='phone'/>697 92 49 93</a>
                </List.Description>
              </List.Content>
            </List.Item>
            <List.Item>
              ...
              <List.Content>
                ...
                <List.Description>Calle Espronceda, 3.<br/>
                  <a href="tel:953 09 75 32"><Icon name='phone'/>953 09 75 32</a>
                </List.Description>
              </List.Content>
            </List.Item>
            <List.Item>
          ...
          <Grid.Row>
            <Grid.Column width={8}>
              <Segment className="details-segment" vertical>
                ...
                <p>La Ceremonia Civil tendrá lugar en el <strong>Palacio de los Marqueses de Linares</strong>, a las 13:30 horas el día 17 de junio de 2017.</p>
				<p>La celebración será en el <strong>Complejo "La Tortuga Azul"</strong> a continuación de la ceremonia.</p>
                <Map/>
              </Segment>
              <Segment className="utils-segment" vertical>
				<Header as="h2" content="Lugares y servicios de interés"/>
